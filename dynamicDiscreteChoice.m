...
The file documents the source code that is available from the GitHub repository \url{https://github.com/jabbring/dynamic-discrete-choice}{jabbring/dynamic-discrete-choice}. You can also download a \url{http://jabbring.git.io/dynamic-discrete-choice/dynamicDiscreteChoice.zip}{\textsc{Zip} archive} that includes both this file and all code. We provide this documentation and code for use and distribution under an MIT license (see the \textsc{LICENSE} file for details). 
