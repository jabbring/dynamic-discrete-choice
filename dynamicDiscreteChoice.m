...
\documentclass{article}
	\title{Dynamic Discrete Choice Models: Methods, Matlab Code, and Exercises\thanks{We wish to thank Jeffrey R. Campbell for help with \textsc{Komments++} and Nan Yang and our students for comments on earlier versions of this code. First draft: February 8, 2011. \copyright 2020 Jaap H. Abbring and Tobias J. Klein.}}
...
This file documents the code in the GitHub repository \url{https://github.com/jabbring/dynamic-discrete-choice}{jabbring/dynamic-discrete-choice}. A \url{http://jabbring.github.io/dynamic-discrete-choice/dynamicDiscreteChoice.zip}{\textsc{Zip} archive} packages both together. We welcome the use of this software under an MIT license (see the \textsc{LICENSE} file for details). 
